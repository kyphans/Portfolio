...
export default function CardAnimation() {
  return (
    <Canvas camera={{ position: [0, 0, 8], fov: 35 }} gl={{ alpha: true }} style={{ background: 'transparent' }}>
...
function Band({ maxSpeed = 50, minSpeed = 10 }: { maxSpeed?: number; minSpeed?: number }) {
  ...
  const segmentProps = { type: 'dynamic' as const, canSleep: true, colliders: false as false, angularDamping: 2, linearDamping: 2 }
